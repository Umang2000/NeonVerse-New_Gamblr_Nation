...
import {
  KickLogo,
  TwitchLogo, // Changed from TwitchIconLucide
  TelegramLogo,
  DiscordLogo,
  XLogo
...
export default function HomePage() {
  ...
  const socialLinks = [
    ...
    { name: 'Twitch', Icon: TwitchLogo, href: '#', dataAiHint: "twitch logo" }, // Using new TwitchLogo
            ...
            <div className="flex justify-center items-center space-x-5 mt-6">
              {socialLinks.map(({ name, Icon, href, dataAiHint }) => (
                <a
                  ...
                  className="text-muted-foreground hover:text-primary transition-colors duration-200" // Kept hover effect on <a>
                  data-ai-hint={dataAiHint}
                >
                  <Icon className="h-7 w-7" /> {/* Size is controlled here */}
                </a>
              ))}
            </div>
