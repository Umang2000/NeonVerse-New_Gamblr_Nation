  ...
  return (
    <Button
      ...
      className={cn(
        ...
        // Hide button if sidebar is open and screen is less than md, as sidebar is full width
        isOpen && "md:translate-x-0 hidden md:flex", 
        !isOpen && "flex", // Ensure it's flex when not open
        isOpen
